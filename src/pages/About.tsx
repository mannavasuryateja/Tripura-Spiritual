    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 animate-fadeIn text-[#2C2421]">
      ...
      <div className="p-8 sm:p-12 rounded-3xl bg-[#3B234A] text-white shadow-xl space-y-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto text-left">
          {/* Email */}
          <a href="mailto:g.peddiraju888@gmail.com" className="flex items-center gap-4 p-4 rounded-2xl bg-white/10 hover:bg-white/15 border border-white/20 transition">
          ...
          {/* Phone */}
          <a href="tel:+918919307373" className="flex items-center gap-4 p-4 rounded-2xl bg-white/10 hover:bg-white/15 border border-white/20 transition">
            <div className="h-12 w-12 rounded-xl bg-[#D1A559] text-stone-900 flex items-center justify-center shrink-0">
        ...
        <div className="flex flex-wrap gap-4 justify-center pt-2">
          <a 
            ...
            className="flex items-center gap-2 px-6 py-3.5 rounded-full bg-emerald-600 hover:bg-emerald-500 transition font-bold text-xs tracking-wider uppercase text-white shadow-md"
          >
          ...
          <a 
            ...
            className="flex items-center gap-2 px-6 py-3.5 rounded-full bg-white/15 hover:bg-white/25 border border-white/30 transition font-bold text-xs tracking-wider uppercase text-white"
          >
