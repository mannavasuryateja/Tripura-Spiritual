        ...
        <div className="glass-panel p-8 rounded-3xl border border-amber-200 shadow-xl space-y-6">
          <div className="flex justify-between items-start border-b border-amber-200/60 pb-6">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-rose-50 border border-rose-200 text-rose-700 hover:bg-rose-100 font-semibold text-xs transition flex items-center gap-1.5 hover:-translate-y-0.5"
            >
              ...
              <div className="flex gap-2 mt-2">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg font-semibold transition ${
                    language === 'en' ? 'bg-amber-600 text-white' : 'bg-stone-100 text-stone-700 hover:bg-stone-200'
                  }`}
                >
                  English
                </button>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg font-semibold transition ${
                    language === 'te' ? 'bg-amber-600 text-white' : 'bg-stone-100 text-stone-700 hover:bg-stone-200'
                  }`}
                >
                  తెలుగు
                </button>
